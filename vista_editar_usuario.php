...
<p><center>Por favor ingrese los datos solicitados para editar registro del usuario seleccionado.</center></p>
        ...
        <div class="form-group col-md-6">
          <label>Carnet</label>
          <input type="text" name="" id="carnet_act" class="form-control input-sm" value="<?php echo $carnet; ?>">
        </div>
        <div class="form-group col-md-6">
          <label>Titulo</label>
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-control" name="tipo_usuario_act" id="tipo_usuario_act">
            <?php
        ...
        <div class="form-group col-md-12">
          <label>Carrera</label>
          <select class="form-control" name="carrera_act" id="carrera_act">
            <?php              
