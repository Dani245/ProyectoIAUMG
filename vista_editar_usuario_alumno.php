...
<p><center>Por favor ingrese los datos solicitados para editar registro del usuario seleccionado.</center></p>
        ...
        <input type="hidden" disabled="false" name="" id="titulo_act" class="form-control input-sm" value="<?php echo $titulo; ?>">        
        
        <div class="form-group col-md-12">
          <label>Carnet</label>
          <input disabled="false" name="" id="carnet_act" class="form-control input-sm" value="<?php echo $carnet; ?>">
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <input disabled="false" name="" id="creditos_act" class="form-control input-sm" value="<?php echo $creditos; ?>">
        </div>
